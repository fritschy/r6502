    ...
    pub fn execute(&mut self, mut count: isize) {
        while count > 0 {
            ...
            match ins {
                ...
                opcode::LDA_ZP => instr::lda(self, AM::Z),
                ...
                opcode::LDX_ZP => instr::ldx(self, AM::Z),
                ...
                opcode::LDY_ZP => instr::ldy(self, AM::Z),
                ...
                opcode::STA_ZP => instr::sta(self, AM::Z),
                ...
                opcode::AND_ZP => instr::and(self, AM::Z),
                ...
                opcode::BIT_ZP => instr::bit(self, AM::Z),
                ...
                opcode::EOR_ZP => instr::eor(self, AM::Z),
                ...
                opcode::ORA_ZP => instr::ora(self, AM::Z),
                ...
                opcode::ADC_ZP => instr::adc(self, AM::Z),
                ...
                opcode::CMP_ZP => instr::cmp(self, AM::Z),
                ...
                opcode::SBC_ZP => instr::sbc(self, AM::Z),
                ...
                opcode::DEC_ZP => instr::dec(self, AM::Z),
                ...
                opcode::INC_ZP => instr::inc(self, AM::Z),
                ...
                opcode::JMP_ABSI => instr::jmp(self, AM::AI),
